...
public class readerReportController {
    @Autowired
    private readerReportService readerReportdao;
    ...
    @RequestMapping(value = "/getReaderGctrlInfo", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/getReaderBookLendInfo", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/getReaderMaxBookLendInfo", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/getReaderprintInfo", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/getReaderDeviceHourInfo", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/getReaderEreadHourInfo", method = RequestMethod.GET)
